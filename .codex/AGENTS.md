...
* Extract shared behavior only after duplication is established; as a default, tolerate up to two similar instances and extract a shared abstraction on the third occurrence. Keep constants, endpoints, and configuration facts in one source of truth.
